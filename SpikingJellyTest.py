...
class PlainNet(nn.Module):
    def __init__(self):
        ...
        self.SNN1 = nn.Sequential(
            layer.Linear(28, 28),
            neuron.IFNode(surrogate_function=surrogate.PiecewiseExp(), detach_reset=True),
        )
...
def main():
    ...
    parser.add_argument('-data-dir', type=str, default='./FMnist', help='root dir of Fashion-MNIST dataset')
